 ...
 */
public class SupergradientSolvtyNodePlugin extends Plugin {
    // The shared instance.
    private static SupergradientSolvtyNodePlugin plugin;

    /**
     * The constructor.
     */
    public SupergradientSolvtyNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SupergradientSolvtyNodePlugin getDefault() {
        return plugin;
    }
